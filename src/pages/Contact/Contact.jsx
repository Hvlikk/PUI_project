    ...
    return (
        <div className="content-wrapper">
            <div className="col left">
                ...
                <h1>📧 Napisz do nas</h1>
                <p>Email: contact@scoretracker.app</p>
                <p>Telefon: +48 123 456 789 (pon.–pt. 9:00–17:00)</p>


                <h1>🛠 Zgłoś problem techniczny</h1>
                <p>Jeśli napotkałeś problemy w działaniu aplikacji lub masz pytania techniczne, odwiedź naszą stronę pomocy lub napisz bezpośrednio na: support@scoretracker.app</p>

                <h1>🤝 Współpraca i partnerstwa</h1>
<p>Chcesz współpracować, zintegrować swoje API z naszą aplikacją lub masz pomysł na rozwój ScoreTrackera? Skontaktuj się: partnerships@scoretracker.app</p>
