// Games.jsx — zmodyfikowana wersja zgodna z projektem figma
...
function Games() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (!matchesRes.ok || !teamsRes.ok || !competitionsRes.ok) throw new Error('API returned error status');
  ...
  const filteredMatches = matches.filter(match => {
    ...
    return home.toLowerCase().includes(search.toLowerCase()) ||
